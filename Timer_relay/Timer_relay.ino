...
#define TIME_PUMP               4 //How much time until the pump goes on

#define TIME_SAVETIME_MINUTES   10 //Every TIME_SAVETIME_MINUTES minutes the current time will be saved to the EEPROM

#define TIME_PUMP_SECONDS       180 //The pump will stay on for these many seconds
...
#define RELAY_PUMP_STATE_ON     HIGH   //Relay pin state for turning the pump on
#define RELAY_PUMP_STATE_OFF    LOW  //Relay pin state for turning the pump off
...
void setup() {
  ...
  digitalWrite(PIN_RELAY_LAMP,RELAY_LAMP_STATE_OFF); //Adicionado por Eduardo
  digitalWrite(PIN_RELAY_PUMP,RELAY_PUMP_STATE_OFF); //Adicionado por Eduardo
